...
# whether we want to print xenon and power substepping information - reccomended yes
print_substepping = True
...
import CEPE
CEPE.CEPE(fissionable_mats=fissionable_mats,
          ...
          print_substepping=print_substepping)
